...
void method01 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method01 - v0.0" );
...
void method02 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method02 - v0.0" );
...
void method03 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method03 - v0.0" );
...
void method04 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method04 - v0.0" );
...
void method05 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method05 - v0.0" );
...
void method06 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method06 - v0.0" );
...
void method07 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method07 - v0.0" );
...
void method08 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method08 - v0.0" );
...
void method09 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method09 - v0.0" );
...
void method10 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method10 - v0.0" );
...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method11 - v0.0" );
...
void method12 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method12 - v0.0" );
...
void method13 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method13 - v0.0" );
...
void method14 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method14 - v0.0" );
...
void method16 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method16 - v0.0" );
...
void method17 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method17 - v0.0" );
...
void method18 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method18 - v0.0" );
...
void method19 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method19 - v0.0" );
...
/**
 Method20 - Ler n caracteres; contar e mostrar 
            os alfanumericos; calcular total
 */
...
void method20 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - Method20 - v0.0" );
    ...
    // acao principal
       tamanho = countAndPrintAlfaNumbers ( quantidade );

    // mostrar quantidade
       IO_printf ( "\nHa', no total, %d caracteres alfanumericos\n", tamanho );
...
/**
 MethodE1 - Ler n caracteres, incluindo espacoes em branco; contar e mostrar 
            os alfanumericos; calcular total
 */
...
void methodE1 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo04E2 - MethodE1 - v0.0" );
    ...
    // acao principal
       tamanho = countAndPrintAlfaNumbersBlank ( quantidade );
...
/**
 MethodE2 - Ler duas cadeias e dizer qual possui mais digitos
 */
...
void methodE2 ( )
{
    // definir dados
      ...
      chars text1  = IO_new_chars ( STR_SIZE );
      strcpy ( text1, STR_EMPTY );

      chars text2  = IO_new_chars ( STR_SIZE );
      strcpy ( text2, STR_EMPTY );

    // identificar
       IO_id ( "Exemplo04E2 - MethodE2 - v0.0" );

    // acao principal
       x = charsWithMoreDigits ( text1, text2 );
    ...
    // repetir ate desejar parar
       do
       {
            ...
            // ler do teclado
               ...
               IO_println ( "20 - Ler n caracteres; contar e mostrar os alfanumericos; calcular total" );
               IO_println ( "21 - Ler n caracteres, incluidno espacoes em branco; contar e mostrar os alfanumericos; calcular total" );
               IO_println ( "22 - Ler duas cadeias e dizer qual possui mais digitos                   ");
               IO_println ( " " );
...
A sequencia 2 possui mais digitos que a 1
...
A sequencia 1 possui mais digitos que a 2

AbCdEf
!@#$%¨

Nenhuma sequencia possui digitos

ABC 123
456 def

Ambas as sequencias possuem a mesma quantidade de digitos
