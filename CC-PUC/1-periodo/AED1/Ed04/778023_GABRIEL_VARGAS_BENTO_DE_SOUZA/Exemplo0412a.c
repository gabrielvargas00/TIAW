...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0412 - Method11 - v0.0" );
...
/**
 Method12 - Ler caracteres e contar as letras maiusculas menores que K (alternativo)
 */
...
{  
    ...
    // identificar
       IO_id ( "Exemplo0412 - Method12 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - Method13 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - Method14 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - Method15 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - Method16 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - Method17 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - Method18 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - Method19 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - Method20 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - MethodE1 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0412 - MethodE2 - v0.0" );
    ...
    // repetir ate desejar parar
       do
       {
            ...
            // ler do teclado
               ...
               IO_println ( "12 - Ler caracteres e contar as letras maiusculas menores que K (alternativo)" );
               // IO_println ( "13 - " );
               // IO_println ( "14 - " );
               // IO_println ( "15 - " );
               // IO_println ( "16 - " );
...
Letras maiusculas menores que K = 1

b.) KKKKK

Letras maiusculas menores que K = 0
...
Letras maiusculas menores que K = 10
