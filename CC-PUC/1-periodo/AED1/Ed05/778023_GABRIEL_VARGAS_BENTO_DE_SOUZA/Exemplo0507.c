...
{
    // identificar
       IO_id ( "Exemplo0507 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0507 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0507 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0507 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0507 - Method05 - v0.0" );
...
{  
    ...
    // identificar
       IO_id ( "Exemplo0507 - Method06 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0507 - Method08 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0507 - Method09 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0507 - Method10 - v0.0" );
...
4: 0000001.0000 / 0000008.0000 = 0.125000
3: 0000001.0000 / 0000006.0000 = 0.166667
2: 0000001.0000 / 0000004.0000 = 0.250000
1: 0000001.0000 / 0000002.0000 = 0.500000
...
** OBS.: a expectativa de resultado esta' errada, no que tange ao 7.4%lf, pois o 7 nao significa a quantidade de casas antes do ponto,
         mas, na verdade, a quantidade de espacoes reservados para o numero no total
