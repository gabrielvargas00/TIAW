...
void method09 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method09 - v0.0" );
...
void method10 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method10 - v0.0" );
...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method11 - v0.0" );
...
void method12 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method12 - v0.0" );
...
void method13 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method13 - v0.0" );
...
void method14 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method14 - v0.0" );
...
void method15 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method15 - v0.0" );
...
void method16 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method16 - v0.0" );
...
void method17 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method17 - v0.0" );
...
void method18 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0318 - Method18 - v0.0" );
    ...
    // mostrar numeros armazenados 
       ...
       for ( i = 0; x < n; i = i + 1, x = x + 1)
       {
           // verificar intervalo
              if ( ( a <= numeros [ i ] ) && ( numeros [ i ] <= b ) )
               {
                   // verificar se multiplo de 5, mas nao de 3
                      if ( ( numeros [ i ] % 5 == 0 ) && 
                           ( ! ( numeros [ i ] % 3 == 0 ) ) )
                       {
                           IO_printf ( "\n" );
...
Total de multiplos de 5 e nao multiplos de 3 no intervalo estabelecido: 2
