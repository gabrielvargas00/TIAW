...
void method01 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method01 - v0.0" );
...
void method02 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method02 - v0.0" );
...
void method03 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method03 - v0.0" );
...
void method04 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method04 - v0.0" );
...
void method05 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method05 - v0.0" );
...
void method06 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method06 - v0.0" );
...
void method07 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method07 - v0.0" );
...
void method08 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method08 - v0.0" );
...
void method09 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method09 - v0.0" );
...
void method10 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method10 - v0.0" );
...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method11 - v0.0" );
...
void method12 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method12 - v0.0" );
...
void method13 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method13 - v0.0" );
...
void method14 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method14 - v0.0" );
...
void method15 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method15 - v0.0" );
...
void method16 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method16 - v0.0" );
...
void method17 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method17 - v0.0" );
...
void method18 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method18 - v0.0" );
...
void method19 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method19 - v0.0" );
...
/**
 Method20 - Mostrar e contar numeros, cuja parte fracionaria
            nao pertencente ao intervalo real (a:b)
 */
...
void method20 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - Method20 - v0.0" );
...
void methodE1 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - MethodE1 - v0.0" );
...
/**
 MethodE2 - Dizer se cadeia tem apenas simbolos
            que nao sao letras
 */
...
void methodE2 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo03E2 - MethodE2 - v0.0" );
    ...
    //       inicio     teste    variacao
       for ( x = 0; x < tamanho; x = x + 1 )
       {
            // contar caracteres que nao sao letras
               if ( ! ( ( 'a' <= caracteres [x] ) && ( 'z' >= caracteres [x] ) ||
                        ( 'A' <= caracteres [x] ) && ( 'Z' >= caracteres [x] ) ) )
                {
                    // passar para proximo
                ...
                {
                    // contar os caracteres que sao letras
                       contador = contador + 1;
                }
        } // end for

    // testar se nenhum caracteres e' letra
       if ( quantidade == tamanho)
       {
           IO_printf ("%s", "\nA cadeia de caracteres contem apenas simbolos que nao sao letras" );
           IO_printf ( "\n" );
       } // end if

       else
       {
           IO_printf ("%s%i%s", "\nHa' [", contador, "] letras na cadeia de caracteres" );
           IO_printf ( "\n" );
       } // end else
    ...
    // repetir ate desejar parar
       do
       {
            ...
            // ler do teclado
               ...
               IO_println ( "21 - " );
               IO_println ( "22 - dizer se a cadeia tem apenas simbolos que nao sao letras" );
               IO_println ( " " );
...
b.) P4!4vR4
Ha' [3] letras na cadeia de caracteres

c.) gabriel
Ha' [7] letras na cadeia de caracteres
