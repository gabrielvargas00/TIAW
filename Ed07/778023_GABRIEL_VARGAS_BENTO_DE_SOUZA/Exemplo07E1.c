...
{
    // identificar
       IO_id ( "Exemplo07E1 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method05 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method06 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method07 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method08 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method09 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E1 - Method10 - v0.0" );
...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo07E1 - Method11 - v0.0" );
...
void method12 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo07E1 - Method12 - v0.0" );
...
void method13 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo07E1 - Method13 - v0.0" );
...
void method14 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo07E1 - Method14 - v0.0" );
...
void method15 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo07E1 - Method15 - v0.0" );
...
void method16 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo07E1 - Method16 - v0.0" );
...
void method17 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo07E1 - Method17 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo07E1 - Method19 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo07E1 - Method20 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo07E1 - MethodE1 - v0.0" );

    // executar metodo auxiliar
       divisores ( "RESULTADO11.TXT" );
...
{
    // identificar
       IO_id ( "Exemplo07E1 - MethodE2 - v0.0" );
...
int main ( )
{
    ...
    // repetir ate desejar parar
       ...
       {
            // identificar
               IO_id ( "Exemplo07E1 - Programa - v0.0" );
...
Gravar em RESULTADO11.TXT:

Sera' aceito apenas numeros positivos

Exemplo: x = 36

Divisores do numero 36:
36
18
12
9
