...
{
    // identificar
       IO_id ( "Exemplo0704 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0704 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0704 - Method03 - v0.0" );
...
Ler arquivo DADOS2.TXT:
(valor 10 sera' usado para controlar a quantidade, nao sendo exibido)
