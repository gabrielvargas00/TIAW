...
{
    // identificar
       IO_id ( "Exemplo0718 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method05 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method06 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method07 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method08 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method09 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0718 - Method10 - v0.0" );
...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0718 - Method11 - v0.0" );
...
void method12 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0718 - Method12 - v0.0" );
...
void method13 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0718 - Method13 - v0.0" );
...
void method14 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0718 - Method14 - v0.0" );
...
void method15 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0718 - Method15 - v0.0" );
...
void method16 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0718 - Method16 - v0.0" );
...
void method17 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0718 - Method17 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0718 - Method19 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0718 - Method20 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0718 - MethodE1 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0718 - MethodE2 - v0.0" );
...
Gravar em arquivo: RESULTADOS08.TXT 

Para n <= 0: ira' pedir um novo valor
...
** Testado para outros valores tambem, como 1, 2, 3, 6, 7
