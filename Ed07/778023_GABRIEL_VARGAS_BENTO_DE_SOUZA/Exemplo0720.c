...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method05 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method06 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method07 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method08 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method09 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0720 - Method10 - v0.0" );
...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0720 - Method11 - v0.0" );
...
void method12 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0720 - Method12 - v0.0" );
...
void method13 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0720 - Method13 - v0.0" );
...
void method14 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0720 - Method14 - v0.0" );
...
void method15 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0720 - Method15 - v0.0" );
...
void method16 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0720 - Method16 - v0.0" );
...
void method17 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0720 - Method17 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0720 - Method19 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0720 - Method20 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0720 - MethodE1 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0720 - MethodE2 - v0.0" );
...
Gravar em RESULTADO10.TXT:

para cada linha, estruturas assim:

Linha lida     = [Exemplo 0720:]
Digito maior 6 = [7]
Resultado      = 1

em seguida, o total que e' 23:

Total de digitos maior 6 = [78...]
Resultado final          = 23
