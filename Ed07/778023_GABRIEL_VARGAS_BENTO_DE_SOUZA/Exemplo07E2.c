...
{
    // identificar
       IO_id ( "Exemplo07E2 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method05 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method06 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method07 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method08 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method09 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo07E2 - Method10 - v0.0" );
...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo07E2 - Method11 - v0.0" );
...
void method12 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo07E2 - Method12 - v0.0" );
...
void method13 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo07E2 - Method13 - v0.0" );
...
void method14 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo07E2 - Method14 - v0.0" );
...
void method15 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo07E2 - Method15 - v0.0" );
...
void method16 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo07E2 - Method16 - v0.0" );
...
/**
 readAndAddUp2 - Ler de arquivo texto certa quantidade de valores 
                 e somar os valores
 @param fileIn  - nome do arquivo para retirar valores
 @param fileOut - nome do arquivo para gravar informacoes
 @param n        - quantidade de valores a serem lidos
...
double readAndAddUp2 ( chars fileIn, chars fileOut, int n )
{
    // definir dados
       FILE*  dados      = fopen ( fileIn,  "rt" );
       FILE*  resultados = fopen ( fileOut, "at" );
       ...
       if ( n > 0 )
       {
                    ...
                    ( w >= n && n >= y ) )
            {
                ...
                // somar valor
                    soma = soma + z;
                // gravar em arquivo
                   IO_fprintf ( resultados, "Termos  somados  = %2d\t Soma atual = %lf\n", y, soma );
                // passar ao proximo
                    y = y + 1;
            } // end while
       } // end if
    ...
    // salvar quantidade e resultado em arquivo
       if ( w >= n && n > 0 )
       {
           IO_fprintf ( resultados, "Quantidade total = %2d\t Soma final = %lf\n\n", n, soma );
       } // end if
       
       else
       {
           IO_fprintf ( resultados, "Quantidade total = %2d\t ERRO: Valor invalido!\n\n", n);
       } // end else
...
/**
 Method17 - Adicionar ao arquivo soma dos (n) primeiros valores
            obtidos na opcao 14
 */
...
void method17 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo07E2 - Method17 - v0.0" );

   // ler do teclado
      n = IO_readint ( "Entre com uma quantidade: " );

  // executar o metodo auxiliar
     readAndAddUp2 ( "DADOS14A.TXT", "RESULTADO07.TXT", n );
...
int fibonacci ( int x )
{
    ...
    // testar se contador valido
       if ( x == 1 || x == 2 )
       {
           // primeiros dois termos iguais a 1
              resposta = 1;
       } // end if
       else
       {
...
/**
 fibonacciEven - Gravar em arquivo certa quantidade 
                 de termos pares da serie de Fibonacci
 @param filename - nome do arquivo para salvar valores
 @return - quantidade de termos pedida
*/

int fibonacciEven ( chars filename )
{
    // definir dados
       FILE*  arquivo = fopen ( filename, "wt" );
       int    n       = 0;
    ...
    // ler do teclado
       n = IO_readint ( "Entre a quantidade de termos: " );

    // testar quantidade
       while ( n <= 0)
       {
           IO_println     ( "Valor invalido! Entre com uma quantidade positiva!" );
           n = IO_readint ( "\nEntre com uma quantidade de termos valida: " );
       } // end while
   ...
   // fechar arquivo
    ...
    // retornar quantidade lida
       return ( n );

} // end fibonacciEven ( )

/**
 Method18 - gravar em arquivo certa quantidade de termos pares da serie de Fibonacci
 */
...
/**
 countUpperCase - Ler de arquivo texto linhas de caracteres e
                  contar quantos sao letras maiusculas
 @param fileIn  - nome do arquivo para receber cadeias
 @param fileOut - nome arquivo para salvar resultado
 @return total de letras maiusculas
*/

int countUpperCase ( chars fileIn, chars fileOut )
{
    // definir dados 
       FILE* dados      = fopen ( fileIn,  "rt" );
       FILE* resultados = fopen ( fileOut, "wt" );
       chars linha      = IO_new_chars ( STR_SIZE );
    ...
    // tentar ler o primeiro
       strcpy ( linha, IO_freadln ( dados) );

    // repetir enquanto houver dados
       while ( ! feof (dados) &&
               strcmp ( "PARAR", linha ) != 0 )
        {
            // obter tamanho da linha
               tamanho = strlen (linha);
            // verificar letras maiusculas
               for ( x = 0; x < tamanho; x = x+1 )
               {
                   ...
                   // testar se maiuscula
                      if ( 'A' <= simbolo && simbolo <= 'Z' )
                      {
                          // contar
                             soma = soma+1;
                          // concatenar maiusculas
                             maiusculas = IO_concat ( maiusculas, IO_toString_c (simbolo) );
                      } // end if
               } // end for
           // gravar em arquivo
               IO_fprintf ( resultados, "Linha lida = [%s]\nMaiusculas = [%s]\nResultado  = %d\n\n", linha, maiusculas, soma );
           // gravar total
              total = total+soma;
              resultado = IO_concat ( resultado, maiusculas );
           // limpar dados
              strcpy ( maiusculas, STR_EMPTY );
              soma = 0;
           // tentar ler o proximo
              strcpy ( linha, IO_freadln ( dados ) );
        } // end while

    // gravar total de maiusculas
       IO_fprintf ( resultados, "Total de maiusculas = [%s]\nResultado final     = %d\n", resultado, total );
...
/**
 Method19 - gravar linhas em arquivo
            mostrar e contar quantos caracteres sao 
            letras maiusculas
 */
...
{
    // identificar
       IO_id ( "Exemplo07E2 - Method19 - v0.0" );

    // gravar cadeia de caracteres em arquivo
       writeText ( "DADOS19.TXT" );

    // mostrar mensagem na tela
       IO_println ( "\nLinhas gravadas no arquivo \"DADOS19.TXT\" " );

    // executar metodo auxiliar
       countUpperCase ( "DADOS19.TXT", "RESULTADO09.TXT" );

    // mostrar mensagem na tela
       IO_println ( "\nVerifique o arquivo \"RESULTADO09.TXT\" para visualizar as letras maiusculas" );
...
/**
 countSevenOrMore - Ler de arquivo texto linhas de caracteres e
                    contar quantos sao letras maiusculas
 @param fileIn  - nome do arquivo para receber cadeias
 @param fileOut - nome arquivo para salvar resultado
 @return total de letras maiusculas
...
int countSevenOrMore ( chars fileIn, chars fileOut )
{
    // definir dados 
       FILE* dados      = fopen ( fileIn,  "rt" );
       FILE* resultados = fopen ( fileOut, "wt" );
       chars linha      = IO_new_chars ( STR_SIZE );
       chars numeros    = IO_new_chars ( STR_SIZE );
       chars resultado  = IO_new_chars ( STR_SIZE );
       int   total      = 0;
       int   tamanho    = 0;
       char  numero     = '_';
    ...
    // repetir enquanto houver dados
       while ( ! feof (dados) &&
               strcmp ( "PARAR", linha ) != 0 )
        {
            ...
            // verificar letras maiusculas
               for ( x = 0; x < tamanho; x = x+1 )
               {
                   // separar simbolo
                      numero = linha[x];
                   // testar se maiuscula
                      if ( '7' <= numero && numero <= '9' )
                      {
                          // contar
                             soma = soma+1;
                          // concatenar maiusculas
                             numeros = IO_concat ( numeros, IO_toString_c (numero) );
                      } // end if
               } // end for
           // gravar em arquivo
               IO_fprintf ( resultados, "Linha lida     = [%s]\nDigito maior 6 = [%s]\nResultado      = %d\n\n", linha, numeros, soma );
           // gravar total
              total = total+soma;
              resultado = IO_concat ( resultado, numeros );
           // limpar dados
              strcpy ( numeros, STR_EMPTY );
              soma = 0;
           // tentar ler o proximo
              strcpy ( linha, IO_freadln ( dados ) );
        } // end while
    ...
    // gravar total de maiusculas
       IO_fprintf ( resultados, "Total de digitos maior 6 = [%s]\nResultado final          = %d\n", resultado, total );
...
} // end countSevenOrMore ( )

/**
 Method20 - gravar linhas em arquivo
            mostrar e contar quantos sao
            digitos iguais ou maiores que sete
 */

void method20 ( )
{
    // identificar
       IO_id ( "Exemplo07E2 - Method20 - v0.0" );

    // gravar cadeia de caracteres em arquivo
       writeText ( "DADOS20.TXT" );

    // mostrar mensagem na tela
       IO_println ( "\nLinhas gravadas no arquivo \"DADOS20.TXT\" " );

    // executar metodo auxiliar
       countSevenOrMore ( "DADOS20.TXT", "RESULTADO10.TXT" );

    // mostrar mensagem na tela
       IO_println ( "\nVerifique o arquivo \"RESULTADO10.TXT\" para visualizar aos digitos maiores que seis" );
...
/**
 divisores - Gravar divisores de um numero em arquivo
 @param fileName - nome do arquivo para receber divisores
*/

void divisores ( chars fileName )
{
   // definir dados
      FILE* arquivo = fopen ( fileName, "at" );
      int   x       = 0;
   ...
   // ler do teclado
      x = IO_readint ( "Entre com um numero positivo: " );
   ...
   // gravar numero a ser testado
      fprintf ( arquivo, "Divisores do numero %d:\n", x );
...
/**
 MethodE1 - gravar divisores de um numero em arquivo
 */

void methodE1 ( )
{
    // identificar
       IO_id ( "Exemplo07E2 - MethodE1 - v0.0" );

    // executar metodo auxiliar
       divisores ( "RESULTADO12.TXT" );
...
/**
 countLetter_A_a - Contar quantas palavras comecam 
                   com A ou com a em arquivo.
 @param fileName - nome do arquivo
 @return quantidade de palavras que comecam com A ou a
*/

int countLetter_A_a ( chars fileName )
{
    // definir dados
       FILE* arquivo  = fopen ( fileName, "rt" );
    ...
    // tentar ler o primeiro
       strcpy ( palavra, IO_freadln ( arquivo ) );

    // repetir enquanto houver dados
       while ( ! feof (arquivo) &&
               strcmp ( "PARAR", palavra ) != 0 )
        {
            // separar simbolo
               letra = palavra[0];

            // testar simbolo e' A ou c
               if ( ( letra == 'A') ||
                    ( letra == 'a') )
                {
                    // contar
...
/**
 MethodE2 - Contar quantas palavras comecam 
            com A ou com a em arquivo.
 */
...
void methodE2 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo07E2 - MethodE2 - v0.0" );

    // executar metodo auxiliar
       x = countLetter_A_a ( "DADOS22.TXT" );

    // mostar valor
       IO_printf ( "Ha' %d palavras comecando com as letras A ou a neste arquivo", x );
...
int main ( )
{
    ...
    // repetir ate desejar parar
       ...
       {
            // identificar
               IO_id ( "Exemplo07E2 - Programa - v0.0" );
            ...
            // ler do teclado
               ...
               IO_println ( "17 - adicionar ao arquivo soma dos n primeiros valores obtidos na opcao 14   " );
               IO_println ( "18 - gravar em arquivo certa quantidade de termos pares da serie de Fibonacci" );
               IO_println ( "19 - gravar linhas caracteres em arquivo contar e mostrar as letras maiusculas");
               IO_println ( "20 - gravar linhas caracteres em arquivo contar e mostrar digitos >= 7       " );
               IO_println ( "21 - gravar divisores de um numero em arquivo                                " );
               IO_println ( "22 - contar quantas palavras comecam com \"A\" ou com \"a\" em arquivo       " );
               IO_println ( " " );
...
Ha' 4 palavras comecando com as letras A ou a neste arquivo
