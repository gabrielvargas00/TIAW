...
{
    // identificar
       IO_id ( "Exemplo0709 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0709 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0709 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0709 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0709 - Method05 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0709 - Method06 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0709 - Method07 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0709 - Method08 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0709 - Method10 - v0.0" );
...
Ler e mostrar palavras de DADOS4.TXT:
...
CORRECAO DA PREVISAO DE TESTE: 

Com este metodo, cada espaco faz com que pule uma linha,
 e as que estao em branco nao sao exibidas.
Alem disso, quando o programa passou pela linha "PARAR AGORA", 
 como leu-se, primeiro, apenas a palavra PARAR, a leitura foi 
...
Logo, nao e' a melhor maneira quando nao se sabe o que, 
 de fato, ha' no arquivo
