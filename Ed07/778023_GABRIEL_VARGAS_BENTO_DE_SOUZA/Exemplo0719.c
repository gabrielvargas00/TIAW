...
{
    // identificar
       IO_id ( "Exemplo0719 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method05 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method06 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method07 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method08 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method09 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0719 - Method10 - v0.0" );
...
void method11 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0719 - Method11 - v0.0" );
...
void method12 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0719 - Method12 - v0.0" );
...
void method13 ( )
{
    ...
    // identificar
       IO_id ( "Exemplo0719 - Method13 - v0.0" );
...
void method14 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0719 - Method14 - v0.0" );
...
void method15 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0719 - Method15 - v0.0" );
...
void method16 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0719 - Method16 - v0.0" );
...
void method17 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0719 - Method17 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0719 - Method20 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0719 - MethodE1 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0719 - MethodE2 - v0.0" );
...
Gravar em DADOS19.TXT:

PaReDe de TiJoLoS VerMElHOS
...
123 $%# abc
PUC MINAS - COREU
Proxima linha e' PARAR
PARAR

Gravar em RESULTADO09.TXT:

para cada linha, estruturas assim:

Linha lida = [PaReDe de TiJoLoS VerMElHOS]
Maiusculas = [PRDTJLSVMEHOS]
Resultado  = 13

em seguida, o total que e' 40:

Total de maiusculas = [PRDTJLSVMEHOS...]
Resultado final     = 40
*/
